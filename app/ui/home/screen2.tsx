...
export default function Screen2({ animation }: { animation: boolean }) {
  const launchAnimation = () => {
    ...
    setTimeout(() => {
      headerText.classList.remove('md:opacity-0');
    ...
    <div
      ...
      <div className='max-w-7xl md:my-12 mt-6 md:px-0 px-4'>
        <div className='md:w-2/3'>
          ...
          <p id='screen2headertext' className='md:text-lg md:opacity-0'>
        ...
        <div className='md:my-12 my-6 grid md:grid-cols-2 grid-cols-1'>
          <div id='screen2div1' className='md:w-3/4 md:opacity-0'>
          ...
          <div id='screen2div2' className='md:w-3/4 md:mt-0 mt-6 md:opacity-0'>
          ...
          <div className='md:my-12 my-6 grid md:grid-cols-2 grid-cols-1'>
          <div id='screen2div3' className='md:w-3/4 md:opacity-0'>
          ...
          <div id='screen2div4' className='md:w-3/4 md:mt-0 mt-6 md:opacity-0'>
